...
public class AccountController {
	...
	// http://localhost:8083/api/accounts/add
	@PostMapping("/add")
	...
	// http://localhost:8083/api/accounts/1
	@GetMapping("/{id}")
  ...
  // Deposite Rest Api
 //  http://localhost:8083/api/accounts/1/deposite
	...
	// Withdraw  Rest Api
	//  http://localhost:8083/api/accounts/1/withdraw
